...
### Chart 3 - Timeline - Smoothed line
...
# Suavizar usando interpolação spline (curva suave)
fig_timeline = px.line(
    timeline_group,
    x="Year",
    y="Value",
    title="Timeline - Energy Production",
    text="Formatted",
)
...
fig_timeline.update_traces(line_shape="spline")  # <- Suaviza a linha
